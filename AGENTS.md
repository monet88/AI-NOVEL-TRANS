...
This project is indexed by GitNexus as **AI-NOVEL-TRANS** (2498 symbols, 4002 relationships, 104 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
